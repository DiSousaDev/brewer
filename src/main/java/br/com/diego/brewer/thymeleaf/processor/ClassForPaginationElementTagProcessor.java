...
public class ClassForPaginationElementTagProcessor extends AbstractElementTagProcessor {
	
	public static final String NOME_TAG = "pagination";
	public static final int PRECEDENCIA = 1000;
	
	public ClassForPaginationElementTagProcessor(String dialectPrefix) {

...
public class ClassForOrderElementTagProcessor extends AbstractElementTagProcessor {
	
	public static final String NOME_TAG = "order";
	public static final int PRECEDENCIA = 1000;
	
	public ClassForOrderElementTagProcessor(String dialectPrefix) {
